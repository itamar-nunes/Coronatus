 ...
 * MethodInterceptors.
 * 
 * @author http://tembrel.blogspot.com/2007/09/injecting-method-interceptors-in-guice.html
 */
public abstract class ExtendedModule extends AbstractModule
{
    ...
    private void ensureSelfInjection()
    {
        ...
        {
            bind(ExtendedModule.class).annotatedWith(getUniqueAnnotation())
                    .toInstance(this);
     ...
     * with some other use of @Named. A better solution would be to invent an
     * Annotation for just this purpose.
     */
